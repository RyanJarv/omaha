...
// Obsolete: GOOPDATE_COULD_NOT_GET_IBRAVEUPDATE - 0x803.
...
// BraveUpdate.exe shell custom error codes.
#define BRAVEUPDATE_E_DLL_NOT_FOUND           \
    MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xB00)
#define BRAVEUPDATE_E_VERIFY_SIGNEE_IS_GOOGLE_FAILED \
    MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xB01)

// Command line parse custom error codes.
#define BRAVEUPDATE_COMMANDLINE_E_NO_SCENARIO_HANDLER \
    MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xC00)
#define BRAVEUPDATE_COMMANDLINE_E_NO_SCENARIO_HANDLER_MATCHED \
