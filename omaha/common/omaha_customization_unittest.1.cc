...
TEST(OmahaCustomizationTest, Constants_RegistryKeys) {
  ...
  EXPECT_GU_STREQ(_T("HKCU\\Software\\Brave\\Update\\Clients\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), USER_REG_CLIENTS_GOOPDATE);  // NOLINT
  EXPECT_GU_STREQ(_T("HKCU\\Software\\Brave\\Update\\ClientState\\"), USER_REG_CLIENT_STATE);  // NOLINT
  EXPECT_GU_STREQ(_T("HKCU\\Software\\Brave\\Update\\ClientState\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), USER_REG_CLIENT_STATE_GOOPDATE);  // NOLINT
  ...
  EXPECT_GU_STREQ(_T("HKLM\\Software\\Brave\\Update\\Clients\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), MACHINE_REG_CLIENTS_GOOPDATE);  // NOLINT
  EXPECT_GU_STREQ(_T("HKLM\\Software\\Brave\\Update\\ClientState\\"), MACHINE_REG_CLIENT_STATE);  // NOLINT
  EXPECT_GU_STREQ(_T("HKLM\\Software\\Brave\\Update\\ClientState\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), MACHINE_REG_CLIENT_STATE_GOOPDATE);  // NOLINT
...
TEST(OmahaCustomizationTest, ConfigManager_RegistryKeys) {
  ...
  EXPECT_GU_STREQ(_T("HKCU\\Software\\Brave\\Update\\Clients\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.user_registry_clients_goopdate());  // NOLINT
  EXPECT_GU_STREQ(_T("HKLM\\Software\\Brave\\Update\\Clients\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.machine_registry_clients_goopdate());  // NOLINT
  EXPECT_GU_STREQ(_T("HKCU\\Software\\Brave\\Update\\Clients\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.registry_clients_goopdate(false));  // NOLINT
  EXPECT_GU_STREQ(_T("HKLM\\Software\\Brave\\Update\\Clients\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.registry_clients_goopdate(true));  // NOLINT
  ...
  EXPECT_GU_STREQ(_T("HKCU\\Software\\Brave\\Update\\ClientState\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.user_registry_client_state_goopdate());  // NOLINT
  EXPECT_GU_STREQ(_T("HKLM\\Software\\Brave\\Update\\ClientState\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.machine_registry_client_state_goopdate());  // NOLINT
  EXPECT_GU_STREQ(_T("HKCU\\Software\\Brave\\Update\\ClientState\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.registry_client_state_goopdate(false));  // NOLINT
  EXPECT_GU_STREQ(_T("HKLM\\Software\\Brave\\Update\\ClientState\\{B131C935-9BE6-41DA-9599-1F776BEB8019}"), cm.registry_client_state_goopdate(true));  // NOLINT
