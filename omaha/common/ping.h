...
class Ping {
 ...
 private:
  ...
  FRIEND_TEST(PingTest, DISABLED_SendUsingBraveUpdate);
  ...
  // Sends pings using the installed BraveUpdate, which runs in the
  ...
  HRESULT SendUsingBraveUpdate(const CString& request_string,
