...
const TCHAR* const kRegValueServiceName           = _T("brave_omaha_service_name");
const TCHAR* const kRegValueMediumServiceName     = _T("brave_omaha_service_name");
const TCHAR* const kRegValueTaskNameC             = _T("brave_omaha_task_name_c");
const TCHAR* const kRegValueTaskNameUA            = _T("brave_omaha_task_name_ua");
...
const TCHAR* const kServicePrefix               = _T("brave_omaha");
const TCHAR* const kMediumServicePrefix         = _T("brave_omaham");
