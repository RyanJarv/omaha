...
const TCHAR* const kRegValueServiceName           = _T("Crystalnix_service_name");
const TCHAR* const kRegValueMediumServiceName     = _T("Crystalnixm_service_name");
const TCHAR* const kRegValueTaskNameC             = _T("Crystalnix_task_name_c");
const TCHAR* const kRegValueTaskNameUA            = _T("Crystalnix_task_name_ua");
...
const TCHAR* const kServicePrefix               = _T("Crystalnix");
const TCHAR* const kMediumServicePrefix         = _T("Crystalnim");
